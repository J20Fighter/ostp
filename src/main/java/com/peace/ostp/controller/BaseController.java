...
public class BaseController {
	...
	public String adminPage(Model model, HttpServletRequest request) {
		...
		if ("1".equals((String) session.getAttribute("isphone")))
			...
			return "redirect:issuser-login-page";
	...
	@RequestMapping(value = { "isshome" }, method = RequestMethod.GET)
	public String directToExamHomePage(Model model, HttpServletRequest request) {
		String result = request.getParameter("result");
		HttpSession session = request.getSession();
		String isshome = "1".equals((String) session.getAttribute("isphone")) ? "phone-home" : "isshome";
		...
		} else if (grantedAuthorities.contains(new GrantedAuthorityImpl("ROLE_PARTA"))) {
			return "redirect:parta/home";
		}  else if (grantedAuthorities.contains(new GrantedAuthorityImpl("ROLE_PARTB"))) {
			return "redirect:partb/home";
		} else if (grantedAuthorities.contains(new GrantedAuthorityImpl("ROLE_PARTC"))) {
			return "redirect:partc/home";
		} else {
			return isshome;
		}
	}
	...
	@RequestMapping(value = { "/parta/home" }, method = RequestMethod.GET)
	public String partaHomePage(Model model, HttpServletRequest request) {

		// return "redirect:/admin/question-list";
		return "redirect:/parta/apply-list";
	}
