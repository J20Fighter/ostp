...
public class IframeResource {
	...
	/**
	 * 基础数据管理 basic_sport 户外运动 basic_outdoor 户外运动类型 basic_zhuangbei 装备功能类型
	 * basic_image 图像风格类型 basic_weizhi 位置类型 basic 基础数据列表
	 */
	...
	/**
	 * 资讯类型 Zixun_add 咨询添加 Zixun_edit 咨询编辑 Zixun_view 咨询详情 Zixun 咨询列表
	 */
	...
	public String Zixun_viewGet(Model model, HttpServletRequest request,@PathVariable String infoid) {
		BasicInfo basicInfo = basicInfoService.selectBasicInfo(infoid);
	...
	/**
	 * 装备管理 zhuangbei_add 装备添加 zhuangbei_edit 装备编辑 zhuangbei_view 装备详情 zhuangbei
	 * 装备列表
	 */
	...
	/**
	 * 摄影管理 sheying_add 添加摄影 sheying_edit 编辑摄影 sheying_view 摄影详情 sheying 摄影列表
	 */
	...
	/**
	 * 位置管理 weizhi_add 位置添加 weizhi_edit 位置编辑 weizhi_view 位置详情 weizhi 位置列表
	 */
	...
	/**
	 * 教程管理 jiaocheng_add 教程添加 jiaocheng_edit 教程编辑 jiaocheng_view 教程详情 jiaocheng
	 * 教程列表
	 * 
	 */
	...
	/**
	 * 行程管理 xingcheng_add 行程添加 xingcheng_edit 行程编辑 xingcheng_view 行程详情 xingcheng
	 * 行程列表
	 */
