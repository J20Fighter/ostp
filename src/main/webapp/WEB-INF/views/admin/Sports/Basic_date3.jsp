	...
	<body>
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
														...
														<div class="dataTables_info" id="sample-table-2_info">
															<div class="btn-group">
																<button class="btn btn-info">
																	...
																	<a href="#modal_form3" role="button" class="green" data-toggle="modal">
																		<i class="icon-double-angle-right"></i>
																		添加文档
																	</a>
																</button>
				...
				<div id="modal_form3" class="modal fade in" tabindex="-1" aria-hidden="false" style="display:none;">
									...
									<div class="row">
										<div class="col-xs-12">
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1">装备功能类型</label>
