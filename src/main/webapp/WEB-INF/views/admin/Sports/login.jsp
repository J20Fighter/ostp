											...
											<fieldset>
												...
												<div class="clearfix">
													<label class="inline"> <input type="checkbox"
														...
														<!-- <a href="Zixun.html" type="button" class="width-35 pull-right btn btn-sm btn-primary"> 
														<i class="icon-key"></i> -->
														<input type="submit" value="登陆" / class="width-35 pull-right btn btn-sm btn-primary"> 登陆
													</a>
												</div>
										...
										<form>
											<fieldset>
												<label class="block clearfix"> <span
													...
													class="ace" /> <span class="lbl"> 我接受这个 <a href="#">用户协议</a>
												</span>
												</label>
