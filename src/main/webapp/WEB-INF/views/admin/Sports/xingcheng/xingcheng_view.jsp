						...
						<div class="col-xs-12">
							...
							<form>
								<div class="row">
									<div class="col-sm-4">
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" id="form-field-1" placeholder="行程名称" class="form-control" disabled="disabled">
													</div>
												</div>
											</div>
											<div class="col-sm-4">
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text" id="form-field-1" placeholder="关键字" class="form-control" disabled="disabled">
													</div>
												</div>
											</div>
								<br />
								<div class="row" style="margin:50px auto 0 auto;width:90%;">
									<!--富文本内容-->
									<textarea name="financial.bz" style="margin:0 auto;"></textarea>
