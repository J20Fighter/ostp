...
<html>
	...
	<%@ include file="head.jsp"%>
		...
		<div id="main-content" class="clearfix">
			...
			<div style="padding-left: 70%;padding-top: 1px;">
				<div style="float: left;margin-top: 3px;"><img src="resources/images/loadingi.gif" /> </div>
	...
	<!-- basic scripts -->
		...
		<script type="text/javascript" src="resources/js/myjs/menusf.js"></script>
		
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="resources/js/myjs/index.js"></script>
	</body>
	</html>