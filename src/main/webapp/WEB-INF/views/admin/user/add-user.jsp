...
<html>
	...
	<body>
		  <form id="user-add-form" action="admin/add-user" >
		  		<div class="form-username">
		  				<label>用户名：</label><input type="text"  name="username" id="username" /><span class="form-message"></span>
		  		</div>
		  		<div class="form-password">
		  				<label>密码：</label><input type="text" name="password" id="password" /><span class="form-message"></span>
		  		</div>
